...
public class TouchKeyHandler implements DeviceKeyHandler {
    ...
    private void launchCamera() {
        ...
        final Intent intent = new Intent(org.derpfest.content.Intent.ACTION_SCREEN_CAMERA_GESTURE);
    ...
    private void doHapticFeedback() {
        ...
        if (mAudioManager.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
            final boolean enabled = Settings.System.getInt(mContext.getContentResolver(),
                    DerpFestSettings.System.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK, 1) != 0;
            if (enabled) {
